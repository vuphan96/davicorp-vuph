...
class AdminExportPointHitoryDetail implements FromView, WithColumnFormatting, WithColumnWidths, WithStyles
{
    public $data;
    public $time;
    ...
    public function view(): View
    {
        return view((new \SCart\Core\Admin\Controllers\RootAdminController())->templatePathAdmin .
            'screen.points.excel.export_point_history_template')->with(['data' => $this->data, "time" => $this->time]);
    }
