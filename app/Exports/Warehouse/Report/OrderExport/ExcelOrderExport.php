...
namespace App\Exports\Warehouse\Report\OrderExport;
...
class ExcelOrderExport implements FromView, WithStyles, WithColumnWidths, WithColumnFormatting
{
    ...
    public function view(): View
    {
        return view((new \SCart\Core\Admin\Controllers\RootAdminController())->templatePathAdmin .
            'screen.warehouse.report.order_export.export_excel_template')->with(['data' => $this->data, 'dataSearch' => $this->dataSearch, 'count' => $this->count]);
    }
    // Change excel style
