...
namespace App\Exports\Warehouse\Report\ProductDept;
...
class ReportProductDeptExcel implements FromView, WithStyles, WithColumnWidths, WithColumnFormatting
{
    ...
    public function view(): View
    {
        return view((new \SCart\Core\Admin\Controllers\RootAdminController())->templatePathAdmin .
            'screen.warehouse.report.warehouse_dept.export_excel_template')->with(['data' => $this->data, 'dataSearch' => $this->dataSearch]);
    }
    // Change excel style
