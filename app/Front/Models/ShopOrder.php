...
class ShopOrder extends Model
{
    ...
    {
        return $this->hasOne(ShopEInvoice::class, 'order_id', 'id');
    }
    ...
    {
        return $this->hasMany(ShopOrderHistory::class, 'order_id', 'id')->orderByDesc('add_date');
    }
    public function returnHistory()
    {
        return $this->hasMany(ShopOrderReturnHistory::class, 'order_id', 'id');
    }
    public function object(){
        return $this->hasOne(ShopOrderObject::class, 'id', 'object_id');
    }
    ...
    public function statusOrder() {
        return $this->belongsTo(ShopOrderStatus::class, 'status', 'id');
    }
    ...
    {
        return $this->hasMany(AdminShopOrderChangeExtra::class, 'order_id', 'id');
    }
    protected static function boot()
    {
        ...
        static::deleting(function ($order) {
            ...
            $order->orderChange()->delete(); //delete history
        });
    ...
    public function getNextId(){
        return ShopGenId::genNextId('order_corp');
    }
}
