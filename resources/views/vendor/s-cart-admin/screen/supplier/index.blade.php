...
@section('main')
    ...
    <!-- Modal -->
    <div class="modal fade" id="permissionLockModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form method="post" action="{{ route("admin_user.lock-time-edit") }}" class="modal-dialog modal-lg" role="document">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Chỉnh sửa hiệu lực khoá đơn hàng</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row mb-1">
                        <div class="col-4"><label>Đơn hàng Davicorp</label></div>
                        <div class="col-8">
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-4">Thời gian hiệu lực đến ngày</div>
                        <div class="col-8">
                            <div class="input-group">
                                <input type="text" name="davicorp_due_time" class="form-control lockDatePicker">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-4"><label>Đơn hàng Davicook</label></div>
                        <div class="col-8">
                        </div>
                    </div>
                    <div class="row mb-1">
                        ...
                        <div class="col-8">
                            <div class="input-group">
                                <input type="text" name="davicook_due_time" class="form-control lockDatePicker">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-4"><label>Chọn tài khoản</label></div>
                        <div class="col-8">
                            <div class="input-group">
                                <select class="form-control input-sm bs-multiselect" id="selectCustomerLockPermission" multiple="multiple"
                                        data-placeholder="Lọc theo tên tài khoản"
                                        name="user_ids[]">
                                    <option value=""></option>
                                    @foreach (($userWithCartPermission ?? [] ) as $k => $v)
                                        <option value="{{ $v->id }}">
                                            {{ $v->name }}
                                        </option>
                                    @endforeach
