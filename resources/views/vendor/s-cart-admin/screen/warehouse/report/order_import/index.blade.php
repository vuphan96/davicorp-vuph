...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function savePdf() {
            ...
            let href = '{{ sc_route_admin('warehouse_report_import.print') }}?keyword=' + keyword + '&category=' + category + '&date_start=' +
        ...
        $('#button_export_filter').on('click', function () {
            ...
            let href = '{{ sc_route_admin('warehouse_report_import.export') }}?keyword=' + keyword +
