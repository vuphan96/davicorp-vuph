...
<div id="invoice" class="webview_hide">
    <table>
        ...
        <tr>
            <th colspan="6" style="text-align: left"> {{ sc_language_render("admin.report.name_cty") }}
            </th>
        </tr>
        <tr>
            <th colspan="6" style="text-align: left">{{ sc_language_render("admin.report.address_cty") }}
            </th>
        </tr>
        <tr>
            <th colspan="6"></th>
        ...
        <tr>
            <th colspan="6" class="invoice_title">BÁO CÁO ĐƠN XUẤT HÀNG</th>
        </tr>
        <tr>
            <th colspan="6" class="invoice_time">Từ {{  $dataSearch['date_start'] }} đến {{ $dataSearch['date_end'] }}</th>
        </tr>
        <tr>
            <th colspan="6" align="center">Kho: -</th>
        </tr>
        <tr>
    ...
    <table style="border-collapse: collapse" border="1px" class="table_detail">
        ...
        <tbody>
        @forelse($data->groupBy(['product_id']) as $keyProduct => $keyProduct)
            <tr>
                <td></td>
    ...
    <table>
        <tr>
            <th colspan="6" align="center" style="border: 1px solid white; border-right: 1px solid #E0E0E0"></th>
        </tr>
        <tr>
            <th colspan="6" style="text-align: right; border: 1px solid white; border-right: 1px solid white; padding-right: 50px">Ngày ...... Tháng ...... năm ..........</th>
        </tr>
        <tr>
            <th colspan="6" style="text-align: right; font-weight: bold; border: 1px solid white; border-right: 1px solid white; padding-right: 120px">Người Lập</th>
        </tr>
        <tr>
            <th colspan="6" style="text-align: right; border: 1px solid white; border-right: 1px solid white; font-style: italic; font-size: 10px; padding-right: 130px">(Ký, họ tên)</th>
        </tr>
        <tr>
            <th colspan="6" align="center"></th>
        </tr>
