...
<table>
    ...
    <tr>
        <th colspan="6" style="border: 1px solid white; border-right: 1px solid #E0E0E0">{{ sc_language_render("admin.report.name_cty") }}
        </th>
    </tr>
    <tr>
        <th colspan="6" style="border: 1px solid white; border-right: 1px solid #E0E0E0">{{ sc_language_render("admin.report.address_cty") }}
        </th>
    </tr>
    <tr>
        <th colspan="6" align="center" style="border: 1px solid white; border-right: 1px solid #E0E0E0"></th>
    ...
    <tr>
        <th colspan="6" align="center"
            style="font-size: 16px; font-weight: 700; border: 1px solid white; border-right: 1px solid #E0E0E0">BÁO CÁO ĐƠN XUẤT HÀNG
        </th>
    </tr>
    <tr>
        <th colspan="6" align="center" style="border: 1px solid white; border-right: 1px solid #E0E0E0">Từ
            ngày {{  $dataSearch['date_start'] }} đến ngày {{ $dataSearch['date_end'] }}</th>
    </tr>
    <tr>
        <th colspan="6" align="center" style="border: 1px solid white; border-right: 1px solid #E0E0E0">Kho: -</th>
    </tr>
    <tr>
        <th colspan="6" align="center" style="border-right: 1px solid #E0E0E0"></th>
    </tr>
    <tr>
    ...
    <tbody>
    @forelse($data->groupBy(['supplier','product_id']) as $keyProduct => $product)
        <tr>
            <td></td>
