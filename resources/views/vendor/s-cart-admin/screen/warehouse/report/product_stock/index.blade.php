...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function savePdf() {
            ...
            let href = '{{ sc_route_admin('warehouse_product_stock.print') }}?keyword=' + keyword +'&date_start=' +
        ...
        $('#button_export').on('click', function () {
            ...
            let href = '{{ sc_route_admin('warehouse_product_stock.export') }}?keyword=' + keyword +
