            ...
            <div class="card">
                <div class="card-header">
                    ...
                    @if ($layout == 'edit')
                        <div class="btn-group float-right" style="margin-right: 5px">
                            <a href="{{ sc_route_admin('admin_warehouse.index') }}" class="btn  btn-flat btn-default"
                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal"
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            {{------------------Mã kho hàng--------------}}
                        <div class="form-group row {{ $errors->has('warehouse_code') ? ' text-red' : '' }}">
                            <label for="warehouse_code"
                                class="col-sm-2 col-form-label">Mã kho<span
                            ...
                            <div class="col-sm-10 ">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="warehouse_code" name="warehouse_code"
                                        value="{{ old() ? old('warehouse_code') : $length['warehouse_code'] ?? '' }}"
                                        class="form-control warehouse_code {{ $errors->has('warehouse_code') ? ' is-invalid' : '' }}">
                                </div>

                                @if ($errors->has('warehouse_code'))
                                    <span class="text-sm" style="color: red">
                                        <i class="fa fa-info-circle"></i> {{ $errors->first('warehouse_code') }}
                                    </span>
                                @endif
                                @if (session('warrning'))
                                    <span class="text-sm" style="color: red">
                        ...
                        <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
                            <label for="name"
                                   class="col-sm-2 col-form-label">Tên kho<span
                                        style="color: red; font-size:20px">*</span>
                            </label>
                            <div class="col-sm-10 ">
                                <div class="input-group mb-3">
                            ...
                            <label for="address"
                                   class="col-sm-2 col-form-label">Địa chỉ kho<span
                                        style="color: red; font-size:20px"></span>
                            </label>
                            <div class="col-sm-10 ">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="address" name="address"
                                        value="{{ old() ? old('address') : $length['address'] ?? '' }}"
                    ...
                    <div class="card-header with-border">
                        ...
                        <div class="float-left">
                            @if (!empty($removeList))
                                ...
                                <div class="menu-left">
                                    <span data-perm="warehouse:delete" class="btn btn-flat btn-danger grid-trash"
                            ...
                            success: function(data) {
                                if (data.error == 1) {
                                    ...
                                    window.location.replace(
                                        '{{ sc_route_admin('admin_warehouse.index') }}'
                                        );
                                }
