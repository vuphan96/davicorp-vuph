                ...
                <div class="modal-content-body">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-md-5" style="text-align: left;">
                            <input name="units_code" readonly class="auto_customer_department_acceptance form-control form-control-sm check-null" type="text">
                        </div>
                        <div class="col-md-1" style="text-align: center">Và
                        </div>
                        <div class="col-md-5" style="text-align: left">
                            <input name="source_code" readonly class="auto_customer_name_acceptance form-control form-control-sm check-null" type="text">
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-md-4">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-md-3" style="text-align: left;">
                            <input name="date" autocomplete="off" class="form-control form-control-sm check-null date_time rounded-0" data-date-format="dd/mm/yyyy" placeholder="Chọn ngày" type="text" value="" required>
                        </div>
                        <div class="col-md-2">
                            chúng tôi gồm :
                        </div>
                    ...
                    <div class="row mb-1">
                        <div class="col-md-7" >
                            Tên khách hàng : <p id="customer_name" style="display: inline-flex; margin: 0; font-weight: bold; text-transform: uppercase"> </p>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <div class="col-md-7" >
                    ...
                    <div class="row mb-1">
                        <div class="col-md-2">
                            <input type="text" min="1" max="12" style="text-align: center;color: black" name="month_contract" readonly class="form-control form-control-sm check-null auto_month" value="">
                        </div>
                        <div class="col-md-1" style="text-align: center">
                            năm
                        </div>
                        <div class="col-md-2">
                            <input type="text" min="0" style="text-align: center;color: black" readonly name="year_contract" class="form-control form-control-sm check-null auto_year" value="">
                        </div>
                    </div>
                    <div class="row mb-1">
