                                    ...
                                    <div class="table-responsive">
                                        <table class="table box-body text-wrap table-bordered table-product">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align: center; min-width: 102px; width: 110px" class="dish_code">Ngày</th>
                                                <th style="text-align: center; min-width: 175px; width: 175px" class="product_name">Tên nguyên liệu</th>
                                                <th style="text-align: left; min-width: 150px; width: 150px" class="bom">Định lượng</th>
                                                <th style="text-align: center; min-width: 140px; width: 140px" class="total_bom">Nguyên liệu suất</th>
                                                <th style="text-align: right; min-width: 135px; width: 135px" class="import_price">Giá nhập</th>
                                                <th style="text-align: right; min-width: 140px; width: 140px" class="amount_of_product_in_order">Tổng tiền Cost</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="7" class="detail_parent_{{ $menuCard->id }}" style="padding: 0px">
                                                        <table class="show-total_{{ $menuCard->id }}">
                                                            <tr>
                                                                <td style="width: 110px; border: none; border-right: 1px solid #dee2e6;"></td>
                                                                <td style="width: 175px; border: none; border-right: 1px solid #dee2e6;"></td>
                                                                <td style="width: 150px; border: none; border-right: 1px solid #dee2e6;"></td>
                                                                <td style="width: 140px; border: none; border-right: 1px solid #dee2e6;"></td>
                                                                <td style="text-align: right; width: 135px; border: none; border-right: 1px solid #dee2e6;"></td>
                                                                <td style="text-align: right; width: 140px; border: none; border-right: 1px solid #dee2e6;">{{ number_format($dish->sum('amount_of_product_in_order')) . '₫'}}</td>
                                                        ...
                                                        <table class="d-none detail_info_{{ $menuCard->id }}">
                                                            @foreach($dish as $item)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right; width: 135px">{{ number_format($item->import_price)}} ₫</td>
                                                                    <td style="text-align: right; width: 140px">{{ number_format($item->amount_of_product_in_order) . '₫'}} </td>
...
{{--                                                    </td>--}}
                                                    <td rowspan="" style="text-align: center">
                                                        <span onclick="deleteMenuCardDetail('{{ $dishId }}', '{{ $menuCard->id }}', '{{ route("admin.davicook_menu_card.dish_of_menu_card_delete") }}');"
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function deleteMenuCardDetail(dish_id, menu_card_id, url) {
            let name = dish_id == null ? 'Bạn mún xóa phiếu con này ?' : 'Bạn mún xóa món ăn này?';
            Swal.mixin({
                customClass: {
        ...
        /**
         * Select món ăn theo khách hàng. Edit
         * @param menu_card_id
         */
