    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right" style="margin-right: 10px">
                            <a href="{{ sc_route_admin('admin.davicook_menu_card.index') }}"
                ...
                @endphp
                <form id="form-submit-all-menu-card" action="{{ sc_route_admin('admin.davicook_menu_card.store_menu_card') }}" method="post" class="form-horizontal" id="form-main"
                      accept-charset="UTF-8" enctype='multipart/form-data'>
                    @csrf
                    <input type="hidden" name="type_object" value="1">
                        ...
                        <div class="col-sm-7">
                            <table class="table box-body text-wrap table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select onChange="changeCustomer();" class="form-control customer_id select2"
                                                style="width: 100%;" name="customer_id" id="customer_id">
                                            <option selected disabled hidden
                                                    value="">{{ sc_language_render('order.admin.select_customer') }}</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="button" id="create_menu_card_children" class=""
                                               value="Tạo mới phiếu con">
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-sm-5" style="height: 350px">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td><input readonly id="total_cost" name="total_cost" value=""
                                               class="form-control card_name"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td-title">Tổng suất ăn</td>
                                    <td><input readonly id="total_number_of_servings" name="total_number_of_servings"
                                               value="" class="form-control card_name"/></td>
                                </tr>
                            </table>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function getSelectDishByCustomer(key) {
            ...
            var type_object = $('[name="type_object"]').val();
        ...
        function changeNumberOfServings(key) {
            ...
            if ($('.pro_by_dish_' + key).length > 0) {
                $('.change_num_of_ser_' + key).trigger('change');
            }
        ...
        function updateTotalAmountInline(key_card, key_index, unit_type) {
            ...
            // console.log(`${total_cost} - ${formated} - ${bom} - ${qty} - ${import_price}`);
