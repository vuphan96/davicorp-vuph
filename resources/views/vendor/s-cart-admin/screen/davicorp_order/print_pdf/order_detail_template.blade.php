...
@forelse($data as $datum)
    ...
    <div id="invoice_{{ $loop->iteration }}">
        <table>
            <tr>
                <td rowspan="1" colspan="1" style="width: 1cm;padding-right: 0.5cm">
                    <img style="width: 85px" class="logo" src="{{ public_path($order->customer ? $order->customer->department->image : "images/print_assets/davicorp.png") }}"/>
                </td>
                <td  style="font-size: 10pt" class="company_title" colspan="5">
                    <b  style="font-size: 10pt">{{ $order->customer->department->name ?? $order->departments->name }}</b>
