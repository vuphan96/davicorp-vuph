...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#button_export_filter').on('click', function () {
            ...
            let href = '{{ sc_route_admin('admin_report_print_stamp_extra.export_excel') }}?keyword=' + keyword + '&from_to=' + from_to + '&end_to=' + end_to + '&ids=' + ids + '&category=' + category + '&key_export=' + key_export + '&order_send_time_from=' + order_send_time_from + '&order_send_time_to=' + order_send_time_to + '&key_export=' + key_export + '&content=' + content + '&department=' + department+ '&zone=' + zone;
        ...
        function saveFilePdf() {
            ...
            let zone = $('#zone').val();
            let department = $('#department').val();
            let href = '{{ sc_route_admin('admin_report_print_stamp_extra.download_file_pdf') }}?keyword=' + keyword + '&from_to=' + from_to + '&end_to=' + end_to + '&ids=' + ids + '&category=' + category + '&key_export=' + key_export + '&order_send_time_from=' + order_send_time_from + '&order_send_time_to=' + order_send_time_to + '&key_export=' + key_export + '&content=' + content + '&department=' + department+ '&zone=' + zone;
            $("#loading").show();
            printPage(href);
            // window.location.href = href;
        }
        function printStampExtraPdf() {
            ...
            let zone = $('#zone').val();
            let department = $('#department').val();
            let href = '{{ sc_route_admin('admin_report_print_stamp_extra.preview_pdf') }}?keyword=' + keyword + '&from_to=' + from_to + '&end_to=' + end_to + '&ids=' + ids + '&category=' + category + '&key_export=' + key_export + '&order_send_time_from=' + order_send_time_from + '&order_send_time_to=' + order_send_time_to + '&key_export=' + key_export + '&content=' + content + '&department=' + department+ '&zone=' + zone;
            $("#loading").show();
            printPage(href);
