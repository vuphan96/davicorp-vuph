    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ sc_route_admin('admin.davicook_dish.import_excel') }}" method="post" accept-charset="UTF-8"
                                    ...
                                    <div>
                                        @if(session()->get('dupticateCode'))
                                            <span class="form-text text-red">
                                                    <i class="fa fa-info-circle"></i> {!! sc_language_render('admin.dish.import_error_dupticate') !!}
                                                    <div class="pl-3">
                                        ...
                                        <span class="form-text">
                                        <i class="fa fa-info-circle"></i> {!! sc_language_render('admin.dish.import.limit') !!}
                                    </span>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 pl-3">
                                        ...
                                        <a class="btn btn-sm btn-success"
                                           href="{{asset('example_import_excel/DanhSachMonAn.xlsx')}}"><i
                                                    class="fa fa-download"></i> Tải mẫu excel import</a>
                                        <a class="btn btn-sm btn-secondary"
                                           href="{{ route('admin.davicook_dish.index') }}"><i class="fa fa-backward"></i>
                                            Quay lại</a>
                                    </div>
                                </div>
                            </div>
