                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('name') ? ' text-red' : '' }}">
                            <label for="name"
                                   class="col-sm-2 col-form-label">{{ sc_language_render('reward.tier.name') }}
                        ...
                        <div class="form-group row {{ $errors->has('rate') ? ' text-red' : '' }}">
                            <label for="name"
                                   class="col-sm-2 col-form-label">{{ sc_language_render('reward.tier.rate') }}
                                &nbsp;<span class="required-icon" title="{{sc_language_render('note.required-field')}}">*</span></label>
                            <div class="col-sm-10 ">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="number" id="rate" name="rate"
                                           value="{{ old() ? old('rate') : $tier['rate'] ?? '' }}"
                                           class="form-control name {{ $errors->has('rate') ? ' is-invalid' : '' }}"
                                           required min="0">
                                </div>

                                @if ($errors->has('rate'))
                                    <span class="text-sm">
                                        <i class="fa fa-info-circle"></i> {{ $errors->first('rate') }}
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.error == 1) {
                                    ...
                                    window.location.replace('{{ sc_route_admin('admin_point_setting.tier.index') }}');
                                }
