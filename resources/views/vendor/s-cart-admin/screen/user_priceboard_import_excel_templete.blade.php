    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ sc_route_admin('admin_priceboard.import') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-excel" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                            ...
                            <div class="fields-group">
                                <div class="form-group">
                                    <div class="col-md-6 pl-3">
                                        ...
                                        <a class="btn btn-sm btn-success" href="{{asset('example_import_excel/BangBaoGia.xlsx')}}"><i class="fa fa-download"></i> Tải mẫu excel import</a>
                                        <a class="btn btn-sm btn-secondary" href="{{ route('admin_priceboard.index') }}"><i class="fa fa-backward"></i> Quay lại</a>
                                    </div>
                                </div>
                            </div>
                            <div class="p-2">
