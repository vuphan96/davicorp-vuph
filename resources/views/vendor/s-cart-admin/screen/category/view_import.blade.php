    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{ sc_route_admin('admin_category.import.post') }}" method="post" accept-charset="UTF-8"
                                    ...
                                    <div>
                                        @if(session()->get('dupticate'))
                                            <span class="form-text text-red">
                                                    ...
                                                    <div class="pl-3">
                                                        @foreach(session()->get('dupticate') as $row_index => $warrning)
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 pl-3">
                                        ...
                                        <a class="btn btn-sm btn-success"
                                           href="{{asset('example_import_excel/DanhMucSanPhamTemplates.xlsx')}}"><i
                                                    class="fa fa-download"></i> Tải mẫu excel import</a>
                                        <a class="btn btn-sm btn-secondary"
                                           href="{{ route('admin_category.index') }}"><i class="fa fa-backward"></i>
                                            Quay lại</a>
                                    </div>
                                </div>
                            </div>
