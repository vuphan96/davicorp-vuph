...
<head>
  ...
  <link rel="stylesheet" href="{{ sc_file('css/admin_custom.css')}}">
...
<div class="wrapper">
  ...
  @php
    ...
    $activeMenu = \App\Admin\Models\AdminMenu::getActiveMenu($menus, url()->current());
  @endphp
...
<script src="{{ sc_file('admin/plugin/toast-notifi/jquery.toast.min.js')}}"></script>
<!-- Admin helper -->
<script src="{{ sc_file('js/admin_helper.js')}}"></script>
