...
return [
    ...
    'between'              => [
        ...
        'string'  => 'Giá trị :attribute phải nằm giữa :min và :max kí tự.',
    ...
    'gte'                  => [
        ...
        'string'  => 'Giá trị :attribute phải lớn hơn hoặc bằng :value kí tự.',
    ...
    'lte'                  => [
        ...
        'string'  => 'Giá trị :attribute phải nhỏ hơn hoặc bằng :value kí tự.',
    ...
    'min'                  => [
        ...
        'string'  => 'Giá trị :attribute nhỏ nhất là :min kí tự.',
    ...
    'size'                 => [
        ...
        'string'  => 'Giá trị :attribute phải là :size kí tự.',
    ...
    'attributes'           => [
        ...
        'ordr_num' => "STT trên tem",
        'short_name' => "Tên in trên tem",
        'bill_name'=> "Tên trên hoá đơn",
        'sort' => "Thứ tự",
        ...
        'avatar' => "Ảnh đại diện",
        'email' => "Email",
        'schoolmaster_code' => "Tên đăng nhập TK Hiệu trưởng",
        'schoolmaster_password' => "Mật khẩu TK Hiệu trưởng",
        'role' => "vai trò"
    ],
