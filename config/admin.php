...
return [
    ...
    // Config time can't update order
    'time_not_edit_order' => '16:30',
    // Enable user register account
    'enable_register_account' => false,
    // Mobile app latest version
    'mobile_app_latest_version' => '1.0.2',
    // Default datepicker display format
