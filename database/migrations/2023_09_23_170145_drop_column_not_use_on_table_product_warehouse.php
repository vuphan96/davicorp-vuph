...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($this->table, function (Blueprint $table) {
            ...
            $table->decimal('qty',11,2)->default(0)->nullable()->comment('Số lượng tồn kho');
            $table->decimal('latest_import_qty',11,2)->default(0)->nullable()->comment('Số lượng nhập gần nhất');
            $table->timestamps();
        });
    }
